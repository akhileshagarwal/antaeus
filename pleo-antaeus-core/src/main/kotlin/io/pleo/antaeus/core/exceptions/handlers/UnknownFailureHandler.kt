...
class UnknownFailureHandler: FailedPaymentHandler {
    ...
    override fun handle(invoiceDLQ: InvoiceDLQ) {
        log.info { "Inform the dev team about this unknown error and raise an alert(Datadog/Graphana/Sentri are some options): $invoiceDLQ" }
    }
}